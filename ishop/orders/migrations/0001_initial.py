...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('items', '0004_alter_item_discount'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='items.item', verbose_name='Товар')),
            ],
            options={
